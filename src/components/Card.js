    ...
    render(){ 
        ...
        return (
            <li className="element-item"  id={this.card._id}>
                ...
                <img className="element-item__image" onClick={this.handleClick} style={{ backgroundImage: `url(${this.card.link})` }} alt=""/>
                <div className="element-item__content">
                    ...
                    <div className="element-item__grop">
                        ...
                        <p className="element-item__number-like">{this.card.likes.length}</p>
                    </div>
                </div>
            </li>
       ) }
