...
componentDidMount() {
    ...
    this.userCards();
     ...
     userProfile =()=>{//получение данных профиля     
    ...
    return (
        ...
        <main className="content">
            ...
            <section className="profile">
                ...
                <img className="profile__avatar"  style={{ backgroundImage: `url(${this.state.userAvatar})` }}  alt=""/>
            ...
            <section className="element">
                <ul className="element__container" >
                    {
                     this.state.cards.map(card =>(<Card key={card._id} card={card} onCardClick={this.props.onCardClick}/>))
                     }
                </ul>
            </section>
        </main>
